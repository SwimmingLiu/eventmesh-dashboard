...
public final class KafkaMetricPersistenceCoordinator {

    private final KafkaMetricsCollector collector;
    private final KafkaMetricStore store;
    private final Clock clock;

    public KafkaMetricPersistenceCoordinator(KafkaMetricStore store) {
    ...
    public KafkaMetricCollection collectAndStore(String organizationId, String clusterId, String clusterName,
        ...
        store.write(new KafkaMetricWriteBatch(organizationId, clusterId, clusterName, startedAt, durationMillis,
            metrics));
        return metrics;
    }
}
