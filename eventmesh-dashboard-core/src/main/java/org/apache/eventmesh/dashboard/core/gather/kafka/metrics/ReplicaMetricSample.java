...
public class ReplicaMetricSample {
    ...
    private ReplicaMetric metric;
    private String broker;
    private TopicPartition topicPartition;
    private BigDecimal value;
    private Instant collectedAt;

    public ReplicaMetricSample() {
    }

    public ReplicaMetricSample(ReplicaMetric metric, String broker, TopicPartition topicPartition,
    ...
    public ReplicaMetric getMetric() {
        return metric;
    }

    public void setMetric(ReplicaMetric metric) {
        this.metric = metric;
    }
